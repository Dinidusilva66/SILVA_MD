...
cmd({
  ...
  try {
    ...
    const _0x166c67 = await _0x5351f6.sendMessage(_0x14fac3, {
      ...
      'caption': `*ꜱɪʟᴠᴀ ᴍᴅ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*

🔊 *Song Title* ➜ *${_0x20e1e8.title}*

📅 *Released* ➜ *${_0x20e1e8.uploadDate}*
🕒 *Timestamp* ➜ *${new Date().toLocaleString()}*
👁️ **Views** ➜ *${_0x20e1e8.views}*


*_Reply the number of the format you like_*
